...
async function insertPurchaseOrderInfoController(req, res) {
  ...
  const getPurchaseOrderInfoByIdController = async (req, res) => {
    const { id } = req.params;
    try {
      const singlePurchaseOrderInfo = await PurchaseOrderInfoService.getPurchaseOrderInfoByIdDB(id);
...
module.exports={getPurchaseOrderInfoController,insertPurchaseOrderInfoController,getPurchaseOrderInfoByIdController,updatePurchaseOrderInfoController,deletePurchaseOrderInfoInformationController}